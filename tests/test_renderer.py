...
def _make_context(
    ...
    return FrameContext(
        ...
        animation=AnimationDef(name="test", row=0, frames=1, timing_ms=100),
...
class TestRenderFrame:
    ...
    def test_render_frame_mixed(self, simple_palette: PaletteConfig) -> None:
        ...
        assert img.getpixel((1, 0)) == context.palette_map["O"]  # "O"
        assert img.getpixel((2, 0)) == context.palette_map["s"]  # "s"
    ...
    def test_render_frame_pixel_accuracy(self, simple_palette: PaletteConfig) -> None:
        ...
        assert img.getpixel((10, 20)) == context.palette_map["h"]
...
class TestRenderFrameVariableSize:
    ...
    def test_render_frame_32x32(self, simple_palette: PaletteConfig) -> None:
        ...
        context = _make_context(simple_palette, frame_width=32, frame_height=32)
        grid = _make_grid(".", width=32, height=32)
        img = render_frame(grid, context)
        assert img.mode == "RGBA"
    ...
    def test_render_frame_48x48(self, simple_palette: PaletteConfig) -> None:
        ...
        context = _make_context(simple_palette, frame_width=48, frame_height=48)
        grid = _make_grid("O", width=48, height=48)
        img = render_frame(grid, context)
        assert img.size == (48, 48)
        assert img.getpixel((0, 0)) == context.palette_map["O"]

    def test_render_frame_128x128(self, simple_palette: PaletteConfig) -> None:
        """128×128 grid renders to 128×128 image."""
        context = _make_context(simple_palette, frame_width=128, frame_height=128)
    ...
    def test_render_frame_non_square(self, simple_palette: PaletteConfig) -> None:
        ...
        context = _make_context(simple_palette, frame_width=64, frame_height=32)
...
class TestRenderRowStrip:
    ...
    def test_render_row_strip_dimensions(self, simple_palette: PaletteConfig) -> None:
        ...
        context = _make_context(simple_palette, spritesheet_columns=14)
        frames = [_make_grid(".") for _ in range(6)]
        strip = render_row_strip(frames, context)
    ...
    def test_render_row_strip_frame_placement(
        ...
        frame0 = _make_grid(".")
        frame1 = _make_grid("O")
        strip = render_row_strip([frame0, frame1], context)
        ...
        assert strip.getpixel((64, 0)) == context.palette_map["O"]
    ...
    def test_render_row_strip_padding_transparent(
        ...
        assert strip.getpixel((0, 0)) == context.palette_map["O"]
...
class TestFrameToPngBytes:
    ...
    def test_frame_to_png_bytes_roundtrip(self, simple_palette: PaletteConfig) -> None:
        ...
        grid = _make_grid(".")
        grid[5] = "." * 5 + "O" + "." * 58
        original = render_frame(grid, context)
    ...
    def test_frame_to_png_bytes_valid_png(self, simple_palette: PaletteConfig) -> None:
        ...
        context = _make_context(simple_palette)
        grid = _make_grid(".")
        png_bytes = frame_to_png_bytes(render_frame(grid, context))
